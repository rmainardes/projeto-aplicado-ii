...
export default function Pedidos() {
  ...
  const clienteName = (id?: number) =>
    clientes.find((c) => c.idCliente === id)?.nome ?? `#${id}`;
              ...
              filtered.map((p) => (
                <TableRow key={p.idPedido}>
                  ...
                  <TableCell className="text-sm">
                    {formaPagamentoLabels[p.formaPagamento]}
                  </TableCell>
                  <TableCell>
                  ...
                  <TableCell>
                    <Button
                      size="icon"
                      variant="ghost"
                      onClick={() => setDetailId(p.idPedido!)}
                    >
