...
export default function ProdutoForm({ open, onOpenChange, produto }: Props) {
  ...
  const mutation = useMutation({
    mutationFn: (values: FormValues) => {
      const dto: ProdutoDTO = { nome: values.nome, descricao: values.descricao, preco: values.preco, quantidadeEstoque: values.quantidadeEstoque, ativo: produto?.ativo ?? true };
